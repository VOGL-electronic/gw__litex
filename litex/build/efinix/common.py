...
efinix_special_overrides = {
    ...
    SDROutputBus           : EfinixSDROutput,
    SDRInputBus            : EfinixSDRInput,
    SDRTristateBus         : EfinixSDRTristate,
    DDROutputBus           : EfinixDDROutput,
    DDRInputBus            : EfinixDDRInput,
    DDRTristateBus         : EfinixDDRTristate,
}
